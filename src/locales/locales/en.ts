const locale: Record<string, string> = {
  ...
  'editor.format.tooltip.once': 'Click: copy formatting and apply it once to the next selection',
  'editor.format.tooltip.locked': 'Double-click: keep painting multiple selections',
  'editor.format.tooltip.exit': 'Click again or press Esc to exit',
  'editor.close': 'Close',
  ...
  'editor.image.menu.borderRadius': 'Border Radius',
  ...
  'editor.video.objectFit': 'Object Fit',
  'editor.video.poster': 'Poster URL',
