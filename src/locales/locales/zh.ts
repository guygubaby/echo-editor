const locale: Record<string, string> = {
  ...
  'editor.nofill': '无填充色',
  'editor.format': '格式刷',
  'editor.format.tooltip.once': '单击：复制当前格式，下一次选择文字后刷一次',
  'editor.format.tooltip.locked': '双击：连续使用，可刷多段文字',
  'editor.format.tooltip.exit': '再次点击格式刷或按 Esc 退出',
  'editor.close': '关闭',
  'editor.modify': '修改',
  ...
  'editor.image.menu.borderRadius': '圆角',
  ...
  'editor.video.objectFit': '对象适应',
  'editor.video.poster': '封面图链接',
